...
public interface BookService {
	...
	// 도서정보 1개를 return하는 기능 수행
	// PK 1개를 전달받아 조회하는 method는 
	// 0..1개의 데이터만 return한다
	// 데이터가 없을 때는 null을 있을때는 실제 데이터가 담긴
	//		DTO가 return 된다
	public BookDTO findById(String bi_isbn);
	
	// 도서명을 1개 전달받아서
	// 도서명으로 조회를 하고 결과를 return하는 기능 수행
	...
	// 삭제할 도서의 ISBN을 1개 전달 받아서 
	// 1개의 도서 정보를 삭제하는 기능 수행
