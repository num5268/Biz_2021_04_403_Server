 ...
 * 
 * Request를 제일먼저 받는 main Class 이다
 * Class 이름은 특별히 중요하지 않다.
 * 
 */
// Web Servlet Annotation
// 지금부터 이 클래스로 생성된 객체는
// Web Service에서 Request를 처리할 객체이 라는 선언
// main() method의 역할을 수행한다.
// Request를 처리하기 위해서는 많은 코드를 작성해야 한다
// 그런데 Network와 관련된 코드는 너무 복잡하고 다양한 기술을
// 요구 하기 때문에 코드를 직접작성하는 것은
// 너무 어렵다
// java에서 제공하는 JDK를 상속받아서 대부분의 기능을 처리해
// 꼭 필요한 기능만 구현을 하게 된다.
...
// 5. doGet() method의 코드를 재 정의(Overriding) 하여 서비스를 
//		구현하게 된다.
...
public class MainController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		// <a href='http://localhost:8080/welcome/book'> book으로
		out.println("<a href='");
