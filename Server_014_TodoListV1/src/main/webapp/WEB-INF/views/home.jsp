	...
	*/	
	...
	table.td_list td.doit {
		...
		*/
		...
		여기 td는 전체 table width를 0으로 지정하고
		ellipsis 설정을 해주면된다
		*/
		max-width: 0;
		overflow: hidden;
...
<body>
	...
	${rootPath}/ 처럼 주소를 지정하는것
	form, a tag등에 URL, URI를 지정할때
	
	주소의 지정방식에 따라 상대주소, 절대주소 방법이
	있는데 지정하는 방법에 따라 연결이
	잘 안되는 경우가 많다.
	
	우리 프로젝트는 모두 절대주좃 지정방식으로 통일을 하고
	항상 주소(URL,URI) 와 관련된 모든 항목은
