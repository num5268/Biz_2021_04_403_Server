...
public interface BookService {
	 ...
	 * Controller에서 Service의 select() method를 호출할 것이있으며
	 * 
	 * select() method는
	...
	public List<BookVO> selectAll(); // READ, 모든 데이터 조회
	/*
	 * Controller로 부터 PK칼럼(bk_isbn)에 해당하는
	 * 값 1개를 전달받고
	 * 
	 * PK 칼럼에 조건을 (1개만) 부여하여 select한 후
	 * 데이터를 return하는 method
	 */
	public BookVO findById(String bk_isbn);
	
	// 도서명으로 검색
	// 도서명을 전달받아서 해당도서명의 모든 데이터를 return
