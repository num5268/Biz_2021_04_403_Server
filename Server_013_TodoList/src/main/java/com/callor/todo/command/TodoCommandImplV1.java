...
public class TodoCommandImplV1 implements TodoCommand {
	...
	protected TodoService toService;
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) 
		...
		Map<String, Object> tdVO = null; 
			...
			// uriPath에서 rootPath를 제외한 나머지만 추출하여 달라
			...
			// Map type에 VO에 현재 날짜, 시각, 할일 정보를
			// 저장하기
			// VO에 칼럼을 추가하면서 동시에 데이터 저장하기
			// Map type의 VO 데이터를 put() 할때
